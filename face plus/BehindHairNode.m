...
-(instancetype)initWithEntity:(BaseEntity *)entity{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ADD_RECORDS_OF_BEHIND_HAIR" object:self userInfo:dict];
