...
//  [self addPinchGesture];
  ...
  if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
    [SVProgressHUD showErrorWithStatus:NSLocalizedString(@"No camera supported", @"么有照相机")];
  }
#endif
}
...
#if SWITCH_SHOW_DEFAULT_IMAGE_FOR_NONE_CAMERA
  if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
    [SVProgressHUD showErrorWithStatus:NSLocalizedString(@"No camera supported", @"没有照相机")];
    return;
  }
#endif
