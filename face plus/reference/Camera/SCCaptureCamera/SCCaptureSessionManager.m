...
- (void)switchFlashMode:(UIButton*)sender {
    ...
    if (!captureDeviceClass) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Notice","提示") message:NSLocalizedString(@"There is no camera found!",@"您的设备没有拍照功能") delegate:nil cancelButtonTitle:NSLocalizedString(@"Sure", nil) otherButtonTitles: nil];
        [alert show];
        return;
    }
...
//        }
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Notice","提示") message:NSLocalizedString(@"Flashlight not found","提示没有闪光灯") delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
        [alert show];
    }
